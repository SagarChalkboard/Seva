...
import { MessageSquare, User, ChevronRight, Plus } from 'lucide-react';
...
export default function Messages() {
    ...
    const handleSelectNewUser = (user) => {
        ...
        // Update URL 
        router.push(`/messages?userId=${user._id}&userName=${encodeURIComponent(user.name)}`, { shallow: true });
    };
                    ...
                    {loading ? (
                        ...
                        <div className="py-16 text-center">
                            ...
                            <p className="text-gray-400 max-w-sm mx-auto mb-6">
                                Start a conversation by messaging other users in your community
                            </p>
                            <button
                                onClick={handleNewMessage}
                                className="px-6 py-3 bg-purple-600 hover:bg-purple-700 text-white rounded-lg transition-colors inline-flex items-center"
                            >
                                <Plus className="w-5 h-5 mr-2" />
                                New Message
                            </button>
